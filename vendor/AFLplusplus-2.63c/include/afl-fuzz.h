...
struct queue_entry {
  ...
  // PMFuzz:
  u8 new_pm_access;                     /* Did this entry accesses PM       */
...
typedef struct afl_state {
  ...
  u8 skip_deterministic,                /* Skip deterministic stages?       */
      ...
      // PMFuzz:
      dont_favor_pm;                    /* Don't favor PM paths             */

  u8 virgin_bits[MAP_SIZE],             /* Regions yet untouched by fuzzing */
      virgin_tmout[MAP_SIZE],           /* Bits we haven't seen in tmouts   */
      virgin_crash[MAP_SIZE],           /* Bits we haven't seen in crashes  */
      // PMFuzz:
      virgin_pm_bits[MAP_SIZE];         /* Regions yet untouched by fuzing PM */
  ...
  /* Types of PM accesses pmfuzz should focus on */
  u32 pmfuzz_focus;
  u32 global_new_pm_find;
  u32 global_unique_find;
  u32 virgin_pm_bits_set;
  u32 rand_count;
  u32 at_capacity;
  u32 pm_path_checks;
  u8  had_new_pm_access;
...
// PMFuzz:
void cull_queue_pm(afl_state_t *);
